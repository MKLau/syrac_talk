...
- R and The Wild Wild West of Code
- Analyses should not be a black box

2. Opportunities (data and code synthesis) (10 min)

- Every script is a perfectly unique snowflake that should be reproducibile
- Replication + Reproducibility 
- Transparency in Science
- Use, Re-use, Benefaction and Synthesis
- Reviewer/Editorial/Journal Policies
- "A scientist, a reviewer and an editor walk into a bar..."
- Crosas, White et al., Poisot, Marwick

3. Tools and resources for improving benefaction not just reproducibility (15 min)



*ReproSci Top 10 Checklist*
...
4. Let the computers do the work! (10 min)
